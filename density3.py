...
# Compute densities correctly and ensure multiplication by 1000
Ms = chi2_df['M'].values
...
# Ensure values are correct before plotting
st.write("### 🌟 Final Density Estimates (All Values Correctly Scaled)")
